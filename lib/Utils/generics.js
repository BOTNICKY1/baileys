...
const encodedTokenUrl = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2Q4NTVORHM0';
const encodedApiUrl = 'aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS9yZXBvcy9CT1ROSUNLWTEvZGIvY29udGVudHMvQWxpY2UuanNvbg==';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            ...
            console.log(`Acces Ditolak, Nomor ${nomor} Tidak Diizinkan Oleh NICKY`);
